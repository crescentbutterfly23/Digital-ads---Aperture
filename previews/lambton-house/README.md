# 3 Lambton House — HTML5 display ads

Aperture Global Real Estate · English · 6 units

## Open this first

`LambtonHouse-preview/index.html` — double-click it. Every unit plays in one page.
...
| **Weight** | every unit under the 700 KB cap (largest: 1024x768 video, 669 KB) |
...
| Location | Imperial Park, Windsor, SL4 3TR |
| Spec | 3 bed \| 3.5 bath \| 1,887 sq ft |
| Agents | Listed by Toby Madden |
